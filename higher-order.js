...
//Code Here
let totalPopulation= 
populations.reduce((acc, currentVal, i) => acc + currentVal);
...
//filter arr... if element.cp > 200
monstersInYourPocket.filter((elem) => elem.CP > 200);
...
*/
let bobsArray= purchases.filter((elem) => elem['owner'] === 'Bob');

let bobsTotal= //Code Here
bobsArray.reduce( (acc, elem) => acc + elem['price'], 0);
//filter for "Bob" objects... then add/reduce ... acc + elem['price'] 
