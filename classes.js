...
//when is length of reports is certain amount... change title...to correct level
//when someone fired... add $100 to bonus
...
class Machine {
  ...
  makeWidgets(num){
    ...
    this.wear_and_tear_count= this.wear_and_tear_count + (Math.floor(num/50));
  }
  fixMachine(){
